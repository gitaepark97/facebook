  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '16px', marginBottom: '16px' }}>
        <Grid style={{ marginTop: '16px', marginBottom: '8px' }} container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} sm={2} md={2}>
            <EditInput label="Name" input={name} setInput={setName} editAction={handleEditName} loading={loading} />
          </Grid>
        </Grid>
        ...
        <Grid style={{ marginTop: '16px', marginBottom: '8px' }} container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} sm={2} md={2}>
            <EditInput label="Email" input={email} setInput={setEmail} editAction={handleEditEmail} loading={loading} />
          </Grid>
        </Grid>
        <Divider variant="middle" />
        <Grid style={{ marginTop: '16px', marginBottom: '8px' }} container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} sm={2} md={2}>
            <EditInput label="Bio" input={bio} editAction={handleEditBio} setInput={setBio} loading={loading} />
          </Grid>
        </Grid>
        <Divider variant="middle" />
        <Grid style={{ marginTop: '16px', marginBottom: '8px' }} container spacing={2} alignItems="center">
